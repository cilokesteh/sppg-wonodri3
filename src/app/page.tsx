...
export const metadata: Metadata = {
  ...
  description:
    "SPPG Wonodri 3 — Satuan Pelayanan Pemenuhan Gizi di Semarang Selatan. 1.560 porsi makan bergizi untuk 12 sekolah & 1 posyandu. Mendukung program Makan Bergizi Gratis (MBG).",
  keywords: [
    "SPPG Wonodri 3",
    "MBG Semarang",
